...
public class LevelThree {
	...
	public LevelThree(ConnectionOfDB connection,String safety, String person) throws SQLException {
		...
		totalEntry = getEntryNumber(false, "", "", "", this.person, "",this.safety ,"");
		systemEntropy = getEntropy(false, "", "", "", this.person,"",this.safety,"");
	...
	public double getBuyingInfoGain() throws SQLException {
		...
		double vhighratio = getEntryNumber(false, "vhigh", "", "", person, "", safety, "") / totalEntry;
		double highratio = getEntryNumber(false, "high", "", "", person, "", safety, "") / totalEntry;
		double medratio = getEntryNumber(false, "med", "", "", person, "", safety, "") / totalEntry;
		double lowratio = getEntryNumber(false, "low", "", "", person, "", safety, "") / totalEntry;
		
		
		
		double vhigh = vhighratio * getEntropy(false, "vhigh", "", "", person, "", safety, "");
		double high = highratio * getEntropy(false, "high", "", "", person, "", safety, "");
		double med = medratio * getEntropy(false, "med", "", "", person, "", safety, "");
		double low = lowratio * getEntropy(false, "low", "", "", person, "", safety, "");
	...
	public double getDoorsInfoGain() throws SQLException {
		double tworatio = getEntryNumber(false, "", "", "2", person, "", safety, "") / totalEntry;
		double threeratio = getEntryNumber(false, "", "", "3", person, "", safety, "") / totalEntry;
		double fourratio = getEntryNumber(false, "", "", "4", person, "", safety, "") / totalEntry;
		double moreratio = getEntryNumber(false, "", "", "0", person, "", safety, "") / totalEntry;
		
		
		
		double vhigh = tworatio * getEntropy(false, "", "", "2", person, "", safety, "");
		double high = threeratio * getEntropy(false, "", "", "3", person, "", safety, "");
		double med = fourratio * getEntropy(false, "", "", "4", person, "", safety, "");
		double low = moreratio * getEntropy(false, "", "", "0", person, "", safety, "");
	...
	public double getLvgBootInfoGain() throws SQLException {
		double bigratio = getEntryNumber(false, "", "", "", person, "big", safety, "") / totalEntry;
		double medratio = getEntryNumber(false, "", "", "", person, "med", safety, "") / totalEntry;
		double smallratio = getEntryNumber(false, "", "", "", person, "small", safety, "") / totalEntry;
		
		
		
		double vhigh = bigratio * getEntropy(false, "", "", "", person, "big", safety, "");
		double med = medratio * getEntropy(false, "", "", "", person, "med", safety, "");
		double low = smallratio * getEntropy(false, "", "", "", person, "small", safety, "");
